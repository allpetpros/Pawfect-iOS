//
//  ExtrasPriceTableViewCell.swift
//  p103-customer
//
...
class ExtrasPriceTableViewCell: UITableViewCell {
    ...
    private func setupLayout() {
        ...
        descriptionLabel.snp.makeConstraints {
            ...
            $0.right.equalTo(checkboxButton).offset(-10)
            $0.left.equalTo(serviceNameLabel)
        }
    }
}
...
extension ExtrasPriceTableViewCell {
    func cellPicked() {
    ...
    func setup(name: String, price: Int, description: String) {

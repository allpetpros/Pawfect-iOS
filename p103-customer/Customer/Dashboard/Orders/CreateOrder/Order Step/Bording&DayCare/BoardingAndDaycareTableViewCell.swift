//
//  BoardingAndDaycareTableViewCell.swift
//  p103-customer
//
...
class BoardingAndDaycareTableViewCell: UITableViewCell {
    ...
    func setupLayout() {
        serviceNameLabel.font = R.font.aileronBold(size: 18)
        
        serviceNameLabel.textColor = .color293147
        serviceImageView.tintColor = .color860000
...
//MARK: - Cell State Setup

extension BoardingAndDaycareTableViewCell {
    func cellPicked() {
...
extension BoardingAndDaycareTableViewCell {
    func setup(section: IndexPath, title: String, price: Int, description: String, size: String, imageUrl: String) {
        descriptionLabel.text = description
        serviceNameLabel.text = title
        serviceSizeLabel.text = "(\(size))"

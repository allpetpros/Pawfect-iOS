...
//  p103-customer
//
//  Created by SOTSYS371 on 06/06/22.
...
class LocationManager: NSObject,CLLocationManagerDelegate {
    ...
    var mapAccessDelegate:MapLocationAccess?
...
//        locationManager.distanceFilter = 0   // 150 in driver app
...
//            locationManager.requestWhenInUseAuthorization() // add in plist NSLocationWhenInUseUsageDescription
    ...
    internal func locationManager(_ manager: CLLocationManager, didUpdateLocations locations: [CLLocation]) {
        ...
        print("LatitudeTest" + latitudeAsString)
        print("LongitudeTest" + longitudeAsString)
...
//                let alert = UIAlertController(title: "", message: "Please allow Location to Pawfect App", preferredStyle: UIAlertController.Style.alert)
...
//                }))
            ...
            case CLAuthorizationStatus.authorizedWhenInUse:
                ...
                if !isEmployeeBottomSheetAdded {
                    mapAccessDelegate?.getOrderDetails()
                } else {
                    break
                }
...
//
//        var urlString = "https://maps.googleapis.com/maps/api/geocode/json?latlng=\(latitude),\(longitude)&key=\(Constant.GOOGLE_API_KEY)" as NSString//"https://maps.googleapis.com/maps/api/geocode/json?latlng=\(latitude),\(longitude)&key=\(Constant.GOOGLE_API_KEY)" as NSString
//
//        urlString = urlString.addingPercentEncoding(withAllowedCharacters: .urlQueryAllowed)! as NSString
...
//                    print("==>> address.fromattedAddress  ",address.formattedAddress)
//                    let addressDict = address.getAddressDictionary()
...
//        addressDict.setValue(route, forKey: "route")
//
//        return addressDict
//    }
...
//            return type?.isEqual(to: component as String) ?? false
//         }
//
//        if (index == NSNotFound){
//
